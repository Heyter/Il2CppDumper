...
public class Il2CppExecutor
{
    ...
    public Il2CppExecutor(Metadata metadata, Il2Cpp il2Cpp)
    {
        ...
        if (il2Cpp.Version >= 27 && il2Cpp.Version < 29)
        {
            ...
            foreach (var imageDef in metadata.imageDefs)
            {
                ...
                {
                    var pointers = il2Cpp.ReadClassArray<ulong>(
                        il2Cpp.MapVATR(codeGenModule.customAttributeCacheGenerator),
    ...
    public string GetGenericInstParams(Il2CppGenericInst genericInst)
    {
        ...
        for (var i = 0; i < genericInst.type_argc; i++)
        {
    ...
    public Il2CppGenericParameter GetGenericParameterFromIl2CppType(Il2CppType il2CppType)
    {
        if (il2Cpp.Version >= 27 && il2Cpp.IsDumped)
        {
            var genericParametersOffset = metadata.Version >= 38
                ? metadata.header.genericParameters.offset
    ...
    {
        return il2Cpp.GetSectionHelper(
