...
public class StructGenerator
{
    ...
    private static readonly HashSet<string> specialKeywords = new(StringComparer.Ordinal) { "inline", "near", "far" };
    ...
    public void WriteScript(string outputDir)
    {
            ...
            for (int typeIndex = imageDef.typeStart; typeIndex < typeEnd; typeIndex++)
            {
                ...
                for (var i = typeDef.methodStart; i < methodEnd; ++i)
                {
                    ...
                    if (methodPointer > 0)
                    {
                        ...
                        methodTypeSignature.Add(
                            methodReturnType.byref == 1 ? Il2CppTypeEnum.IL2CPP_TYPE_PTR : methodReturnType.type);
                        ...
                        for (var j = 0; j < methodDef.parameterCount; j++)
                        {
                            ...
                            methodTypeSignature.Add(
                                parameterType.byref == 1 ? Il2CppTypeEnum.IL2CPP_TYPE_PTR : parameterType.type);
                    ...
                    if (il2Cpp.methodDefinitionMethodSpecs.TryGetValue(i, out var methodSpecs))
                    {
                        foreach (var methodSpec in methodSpecs)
                        {
                            ...
                            if (genericMethodPointer > 0)
                            {
                                ...
                                var (methodSpecTypeName, methodSpecMethodName) =
                                    executor.GetMethodSpecName(methodSpec, true);
        ...
        for (var i = 0; i < orderedPointers.Count; i++)
        {
    ...
    public static string GetMethodTypeSignature(List<Il2CppTypeEnum> types)
    {
        ...
        foreach (var type in types)
        {
            signature += type switch
            {
                ...
                Il2CppTypeEnum.IL2CPP_TYPE_BOOLEAN or Il2CppTypeEnum.IL2CPP_TYPE_CHAR or Il2CppTypeEnum.IL2CPP_TYPE_I1
                    or Il2CppTypeEnum.IL2CPP_TYPE_U1 or Il2CppTypeEnum.IL2CPP_TYPE_I2 or Il2CppTypeEnum.IL2CPP_TYPE_U2
                    or Il2CppTypeEnum.IL2CPP_TYPE_I4 or Il2CppTypeEnum.IL2CPP_TYPE_U4 => "i",
                ...
                Il2CppTypeEnum.IL2CPP_TYPE_STRING or Il2CppTypeEnum.IL2CPP_TYPE_PTR
                    or Il2CppTypeEnum.IL2CPP_TYPE_VALUETYPE or Il2CppTypeEnum.IL2CPP_TYPE_CLASS
                    or Il2CppTypeEnum.IL2CPP_TYPE_VAR or Il2CppTypeEnum.IL2CPP_TYPE_ARRAY
                    or Il2CppTypeEnum.IL2CPP_TYPE_GENERICINST or Il2CppTypeEnum.IL2CPP_TYPE_TYPEDBYREF
                    or Il2CppTypeEnum.IL2CPP_TYPE_I or Il2CppTypeEnum.IL2CPP_TYPE_U or Il2CppTypeEnum.IL2CPP_TYPE_OBJECT
                    or Il2CppTypeEnum.IL2CPP_TYPE_SZARRAY or Il2CppTypeEnum.IL2CPP_TYPE_MVAR => "i",
    ...
    private void AddStruct(Il2CppTypeDefinition typeDef)
    {
        ...
        structInfo.IsValueType = typeDef.bitfield.ValueType;
    ...
    {
        if (!typeDef.bitfield.ValueType && !typeDef.bitfield.EnumType)
        {
    ...
    private void AddFields(Il2CppTypeDefinition typeDef, StructInfo structInfo, Il2CppGenericContext context)
    {
        if (typeDef.field_count > 0)
        {
            ...
            for (var i = typeDef.fieldStart; i < fieldEnd; ++i)
            {
                ...
                var structFieldInfo = new StructFieldInfo { FieldTypeName = ParseType(fieldType, context) };
    ...
    private void AddVTableMethod(StructInfo structInfo, Il2CppTypeDefinition typeDef)
    {
        ...
        for (var i = 0; i < typeDef.vtable_count; i++)
        {
    ...
    private void ParseArrayClassStruct(Il2CppType il2CppType, Il2CppGenericContext context)
    {
        ...
        arrayClassHeader.Append(
            $"struct {structName}_array {{\n" +
            $"\tIl2CppObject obj;\n" +
    ...
    private string RecursionStructInfo(StructInfo info)
    {
        ...
        if (info.RGCTXs.Count > 0)
        {
            ...
            for (var i = 0; i < info.RGCTXs.Count; i++)
            {
        ...
        if (info.VTableMethod.Length > 0)
        {
            ...
            for (var i = 0; i < info.VTableMethod.Length; i++)
            {
    ...
    private bool IsValueType(Il2CppType il2CppType, Il2CppGenericContext context)
    {
        switch (il2CppType.type)
        {
            case Il2CppTypeEnum.IL2CPP_TYPE_VALUETYPE:
                {
                    var typeDef = executor.GetTypeDefinitionFromIl2CppType(il2CppType);
                    return !typeDef.bitfield.EnumType;
                }
            case Il2CppTypeEnum.IL2CPP_TYPE_GENERICINST:
                {
                    var genericClass = il2Cpp.MapVATR<Il2CppGenericClass>(il2CppType.data.generic_class);
                    var typeDef = executor.GetGenericClassTypeDefinition(genericClass);
                    return typeDef.bitfield.ValueType && !typeDef.bitfield.EnumType;
                }
            case Il2CppTypeEnum.IL2CPP_TYPE_VAR:
                {
                    if (context != null)
