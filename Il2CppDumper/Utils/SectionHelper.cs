...
{
    private static readonly byte[] featureBytes =
    {
    ...
    public List<SearchSection> Exec { get; private set; }

    public List<SearchSection> Data { get; private set; }

    public List<SearchSection> Bss { get; private set; }
