...
public sealed class NSO : Il2Cpp
{
    ...
    public NSO(Stream stream) : base(stream)
    {
        ...
        {
            Magic = ReadUInt32(), Version = ReadUInt32(), Reserved = ReadUInt32(), Flags = ReadUInt32()
        };
        ...
        {
            FileOffset = ReadUInt32(), MemoryOffset = ReadUInt32(), DecompressedSize = ReadUInt32()
        };
        ...
        header.APIInfo = new NSORelativeExtent { RegionRoDataOffset = ReadUInt32(), RegionSize = ReadUInt32() };
        header.DynStr = new NSORelativeExtent { RegionRoDataOffset = ReadUInt32(), RegionSize = ReadUInt32() };
        header.DynSym = new NSORelativeExtent { RegionRoDataOffset = ReadUInt32(), RegionSize = ReadUInt32() };
        ...
        if (!IsCompressed)
        {
            ...
            {
                FileOffset = bssStart, MemoryOffset = bssStart, DecompressedSize = bssEnd - bssStart
            };
    ...
    {
        get => isTextCompressed || isRoDataCompressed || isDataCompressed;
    }
